...
int8_t Exploration::executeExploringMap(bool initialize)
{
    ...
    */
    ...
    frontiers_ = find_map_frontiers(currentMap_, homePose_, minFrontierLength = 0.35);
    currentPath_ =  plan_path_to_frontier(frontiers_, homePose_, currentMap_, planner_);
...
int8_t Exploration::executeReturningHome(bool initialize)
{
    ...
    */
    dist(currentPose_, targetPose_) < kReachedPositionThreshold  :  reached the home pose
    currentPath_.path_length > 1  :  currently following a path to the home pose
